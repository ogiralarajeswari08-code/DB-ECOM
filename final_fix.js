...
// Check all the remaining files that might have the issue
const remainingFilesToCheck = [
  ...
  'src/Customer/Categories/Products/Groceries/GroceryCard.js'
];

remainingFilesToCheck.forEach(checkAndFixMissingGetImageSrc);
console.log('Final check and fix completed');
